...
int main(int argc, char** argv){
  ...
  treehists.addFile("/nfs/dust/cms/user/gonvaq/CMSSW/CMSSW_"+CMSSW+"/src/UHH2/VLQToTopAndLepton/config/"+folder+"/uhh2.AnalysisModuleRunner.MC.BprimeB-1000_RH.root","hist",20,-1,false,"B+b M(1000)",0,1);
  treehists.addFile("/nfs/dust/cms/user/gonvaq/CMSSW/CMSSW_"+CMSSW+"/src/UHH2/VLQToTopAndLepton/config/"+folder+"/uhh2.AnalysisModuleRunner.MC.BprimeT-1000_RH.root","hist",30,-1,false,"B+t M(1000)",0,1);
  treehists.addFile("/nfs/dust/cms/user/gonvaq/CMSSW/CMSSW_"+CMSSW+"/src/UHH2/VLQToTopAndLepton/config/"+folder+"/uhh2.AnalysisModuleRunner.MC.BprimeB-1500_RH.root","hist",40,-1,false,"B+b M(1500)",0,1);
  treehists.addFile("/nfs/dust/cms/user/gonvaq/CMSSW/CMSSW_"+CMSSW+"/src/UHH2/VLQToTopAndLepton/config/"+folder+"/uhh2.AnalysisModuleRunner.MC.BprimeT-1500_RH.root","hist",12,-1,false,"B+t M(1500)",0,1);
  ...
  treehists.Draw("Length$(slimmedJetsAK8_SoftDrop.slimmedJetsAK8_SoftDrop.m_subjets.m_eta)","weight","5,-0.5,4.5","AK8 #phi","Events",false);
  ...
  treehists.Draw("slimmedMETs.m_pt+slimmedMuonsUSER.slimmedMuonsUSER.m_pt","weight","70,250,2000","H_{T,lep} [GeV]","Events");
  treehists.Draw("slimmedMETs.m_pt+slimmedMuonsUSER.slimmedMuonsUSER.m_pt+HT","weight","70,250,2000","S_{T} [GeV]","Events");


  //forward jet
  //X2
  treehists.Draw("Chi2Dis.forwardJet.pt()>0","weight*(TopTagDis.mass==-1 )","6,-.5,5.5"," X^{2} forward ak4");
  treehists.Draw("Chi2Dis.forwardJet.eta()","weight*(TopTagDis.mass==-1 && Chi2Dis.forwardJet.pt() > 0)","50,-5,5","forward ak4 #eta","Events",false);
  treehists.Draw("Chi2Dis.forwardJet.energy()","weight*(TopTagDis.mass==-1 && Chi2Dis.forwardJet.pt() > 0)","50,100,1200","forward ak4 E","Events",false);
  treehists.Draw("Chi2Dis.forwardJet.pt()","weight*(TopTagDis.mass==-1 && Chi2Dis.forwardJet.pt() > 0)","50,30,200","forward ak4 p_{T}","Events",false);
  //toptag
  treehists.Draw("TopTagDis.forwardJet.pt()>0","weight*(TopTagDis.mass>-1)","6,-.5,5.5","toptag forward ak4");
  treehists.Draw("TopTagDis.forwardJet.eta()","weight*(TopTagDis.mass>-1 && TopTagDis.forwardJet.pt() > 0)","20,-5,5","forward ak4 #eta","Events",false);
  treehists.Draw("TopTagDis.forwardJet.energy()","weight*(TopTagDis.mass>-1 && TopTagDis.forwardJet.pt() > 0)","50,100,1200","forward ak4 E","Events",false);
  treehists.Draw("TopTagDis.forwardJet.pt()","weight*(TopTagDis.mass>-1 && TopTagDis.forwardJet.pt() > 0)","50,30,200","forward ak4 p_{T}","Events",false);
  ...
  treehists.Draw("TopTagDis.mass","weight*("+toptag_central_string+")","30,1500,3000","central toptag B mass [GeV]");
  ...
  treehists.Draw("TopTagDis.mass","weight*("+toptag_forward_string+")","30,1500,3000","forward toptag B mass [GeV]");
  treehists.Draw("TopTagDis.mass","weight*("+toptag_forward_string+" && slimmedMETs.m_pt >55)","30,1500,3000","forward toptag B mass [GeV]");
