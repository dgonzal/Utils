...
int main(int argc, char** argv){
  string version = "_2jets_v4";//"_wtag_topjetcorr";//"w2jet";//"wtag_topjetcorr";
  string CMSSW = "8_0_24_patch1";
  string folder = "MuSel"+version;
  bool electron = false;
  bool errors = false;
  bool blind = true;
  string resultfile = "w2jet_money.ps";//"moneyplots.pdf";
  bool single = false; 
  ...
  if (electron){
    ...
    if(single) resultfile= "plots/singleMuMoneyCHS_reco/";
  }
