...
int main(){
  ...
  string dir = "/nfs/dust/cms/user/gonvaq/CMSSW/CMSSW_8_0_24_patch1/src/UHH2/VLQToTopAndLepton/config/TriggerSel_v4/";
  bool single = false;
  string appendix ="";
  ...
  MuonTrigger_Bpb_LH.loadHists("data_trigger_MuonHists/pt_1","HLT_Mu50_OR_METNoMu120_data_trigger_MuonHists/pt_1","Combi Mu50 & METNoMu");
  MuonTrigger_Bpb_LH.plotEffi(4);
  MuonTrigger_Bpb_LH.clear_histos();
  ...
  //MuonTrigger_Bpb_LH.loadHists("data_trigger_MuonHists/pt_1","MuCombi_data_trigger_MuonHists/pt_1","Combi Mu50 & METNoMu 120 with MET >250");
  MuonTrigger_Bpb_LH.loadHists("data_trigger_MuonHists/pt_1","HLT_Mu50_data_trigger_MuonHists/pt_1","Mu50");
  MuonTrigger_Bpb_LH.loadHists("data_trigger_MuonHists/pt_1","HLT_Mu50_OR_METNoMu120_data_trigger_MuonHists/pt_1","Combi Mu50 & METNoMu");
  MuonTrigger_Bpb_LH.plotEffi(4);
  MuonTrigger_Bpb_LH.clear_histos();
