...
int main(){
  ...
  MuonTrigger_Bpb_LH.plotEffi(4);
  MuonTrigger_Bpb_LH.clear_histos();
  MuonTrigger_Bpb_LH.loadHists("2D_Selection_muon_trigger_MuonHists/pt_1","HLT_Mu50_2DIso_muon_trigger_MuonHists/pt_1","Mu50");
  MuonTrigger_Bpb_LH.plotEffi(4);
  MuonTrigger_Bpb_LH.clear_histos();  
  ...
  EleTrigger_Bpb_LH.plotEffi(4);
  EleTrigger_Bpb_LH.clear_histos();
  EleTrigger_Bpb_LH.loadHists("2D_Selection_ele_trigger_ElectronHists/pt_1","HLT_Ele50_CaloIdVT_GsfTrkIdT_PFJet165_2DIso_ak4_ele_trigger_ElectronHists/pt_1","Ele50 PF165");
  EleTrigger_Bpb_LH.plotEffi(4);
  EleTrigger_Bpb_LH.clear_histos();
  EleTrigger_Bpb_LH.loadHists("185_jetpt_2D_ele_trigger_ElectronHists/pt_1","HLT_Ele50_CaloIdVT_GsfTrkIdT_PFJet165_2DIso_ak4_ele_trigger_ElectronHists/pt_1","Ele50 PF165");
  EleTrigger_Bpb_LH.plotEffi(4);
  EleTrigger_Bpb_LH.clear_histos();
  EleTrigger_Bpb_LH.loadHists("2D_Selection_ele_trigger_ElectronHists/pt_1","HLT_Ele115_CaloIdVT_GsfTrkIdT_2DIso_ele_trigger_ElectronHists/pt_1","Ele115");
  EleTrigger_Bpb_LH.plotEffi(4);
  EleTrigger_Bpb_LH.clear_histos();
