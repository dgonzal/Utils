...
int main(int argc, char** argv){
  ...
  treehists.Draw("Chi2Dis.wHad.M()","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==12 &&"+chi2cut+")","70,0,120","X^{2} W_{had} mass [GeV]","Events",false);
  treehists.Draw("Chi2Dis.wHad.pt()","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==12 &&"+chi2cut+")","70,30,700","X^{2} W_{had} p_{T} [GeV]","Events",false);
  treehists.Draw("Chi2Dis.mass","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==12 &&"+chi2cut+")","70,300,3000","B mass [GeV]");
  ...
  treehists.Draw("Chi2Dis.wHad.M()","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==11 &&"+chi2cut+")","70,0,120","X^{2} W_{had} mass [GeV]","Events",false);
  treehists.Draw("Chi2Dis.wHad.pt()","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==11 &&"+chi2cut+")","70,30,700","X^{2} W_{had} p_{T} [GeV]","Events",false);
  treehists.Draw("Chi2Dis.mass","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==11 &&"+chi2cut+")","70,300,3000","B mass [GeV]");
  ...
  treehists.Draw("Chi2Dis.topHad.M()","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==12 && Chi2Dis.num_whad == 1&&"+chi2cut+")","70,0,300","X^{2} top_{had} mass [GeV]");
  treehists.Draw("Chi2Dis.topHad.pt()","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==12 && Chi2Dis.num_whad == 1&&"+chi2cut+")","70,0,1000","X^{2} top_{had} p_{T} [GeV]");
  treehists.Draw("Chi2Dis.wHad.M()","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==12 && Chi2Dis.num_whad == 1&&"+chi2cut+")","70,0,120","X^{2} W_{had} mass [GeV]","Events",false);
  treehists.Draw("Chi2Dis.wHad.pt()","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==12 && Chi2Dis.num_whad == 1&&"+chi2cut+")","70,30,700","X^{2} W_{had} p_{T} [GeV]","Events",false);
  treehists.Draw("Chi2Dis.mass","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==12 && Chi2Dis.num_whad == 1&&"+chi2cut+")","70,300,3000","B mass [GeV]");
  treehists.Draw("Chi2Dis.chi","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==12 && Chi2Dis.num_whad == 1&&"+chi2cut+")","70,0,20","X^{2} top_{had} X_{dis}");

  treehists.Draw("Chi2Dis.topLep.M()","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==11 && Chi2Dis.num_whad == 1&&"+chi2cut+")","70,0,300","X^{2} top_{lep} mass [GeV]");
  treehists.Draw("Chi2Dis.topLep.pt()","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==11 && Chi2Dis.num_whad == 1&&"+chi2cut+")","70,50,1000","X^{2} top_{lep} p_{T} [GeV]");
  treehists.Draw("Chi2Dis.wHad.M()","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==11 && Chi2Dis.num_whad == 1&&"+chi2cut+")","70,0,120","X^{2} W_{had} mass [GeV]","Events",false);
  treehists.Draw("Chi2Dis.wHad.pt()","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==11 && Chi2Dis.num_whad == 1&&"+chi2cut+")","70,30,1000","X^{2} W_{had} p_{T} [GeV]","Events",false);
  treehists.Draw("Chi2Dis.mass","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==11 && Chi2Dis.num_whad == 1&&"+chi2cut+")","70,300,3000","B mass [GeV]");
  treehists.Draw("Chi2Dis.chi","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==11 && Chi2Dis.num_whad == 1&&"+chi2cut+")","70,0,20","X^{2} top_{lep} X_{dis}");
  
  treehists.Draw("Chi2Dis.wLep.M()","weight*(TopTagDis.mass==-1 && Chi2Dis.num_whad == 1&&"+chi2cut+")","70,0,120","X^{2} W_{lep} mass [GeV]");

  treehists.Draw("Chi2Dis.topHad.M()","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==12 && Chi2Dis.num_top == 0 && Chi2Dis.num_whad == 1 &&"+chi2cut+")","70,0,300","X^{2} top_{had} mass [GeV]");
  treehists.Draw("Chi2Dis.topHad.pt()","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==12 && Chi2Dis.num_top == 0 && Chi2Dis.num_whad == 1 &&"+chi2cut+")","70,50,1000","X^{2} top_{had} p_{T} [GeV]");
  treehists.Draw("Chi2Dis.mass","weight*(TopTagDis.mass==-1 && Chi2Dis.num_top == 0 && Chi2Dis.num_whad == 1 &&"+chi2cut+")","70,300,3000","X^{2} B mass [GeV]");
  treehists.Draw("Chi2Dis.chi","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==12 && Chi2Dis.num_top == 0 && Chi2Dis.num_whad == 1 &&"+chi2cut+")","70,0,20","X^{2} top_{had} X_{dis}");
  
  treehists.Draw("Chi2Dis.topHad.pt()","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==12 &&"+chi2cut+")","70,50,1000","X^{2} top_{had} p_{T} [GeV]");
  treehists.Draw("Chi2Dis.topLep.pt()","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==11 &&"+chi2cut+")","70,50,1000","X^{2} top_{lep} p_{T} [GeV]");
  return 0;
  ...
  treehists.Draw("Chi2Dis.topHad.M()","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==12 && Chi2Dis.num_whad == 1&&"+chi2cut+")","70,0,300","X^{2} top_{had} mass [GeV]");
  treehists.Draw("Chi2Dis.topLep.M()","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==11 && Chi2Dis.num_whad == 1&&"+chi2cut+")","70,0,300","X^{2} top_{lep} mass [GeV]");
  treehists.Draw("Chi2Dis.wHad.M()","weight*(TopTagDis.mass==-1 && Chi2Dis.num_whad == 1&&"+chi2cut+")","70,0,120","X^{2} W_{had} mass [GeV]","Events",false);
  treehists.Draw("Chi2Dis.wHad.pt()","weight*(TopTagDis.mass==-1 && Chi2Dis.num_whad == 1&&"+chi2cut+")","70,30,700","X^{2} W_{had} p_{T} [GeV]","Events",false);

  treehists.Draw("Chi2Dis.wLep.M()","weight*(TopTagDis.mass==-1 && Chi2Dis.num_whad == 1&&"+chi2cut+")","70,0,120","X^{2} W_{lep} mass [GeV]");
  treehists.Draw("Chi2Dis.mass","weight*(TopTagDis.mass==-1 && Chi2Dis.num_whad == 1&&"+chi2cut+")","70,300,3000","B mass [GeV]");
  treehists.Draw("Chi2Dis.chi","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==12 && Chi2Dis.num_whad == 1&&"+chi2cut+")","70,0,20","X^{2} top_{had} X_{dis}");
  treehists.Draw("Chi2Dis.chi","weight*(TopTagDis.mass==-1 && Chi2Dis.recoTyp==11 && Chi2Dis.num_whad == 1&&"+chi2cut+")","70,0,20","X^{2} top_{lep} X_{dis}");
  ...
  treehists.Draw(deltaRstring("Chi2Dis.bprime","BprimeGen.bprime")+"<0.8","weight*(TopTagDis.mass==-1 &&"+chi2cut+" && BprimeGen.bprime.M()>400 )","5,-.5,4.5","matched VLQ #Delta R(B_{reco},B_{gen})<0.8");
