...
void limit(const char * signal,const char * resultfile , const char *dirname="/nfs/dust/cms/user/gonvaq/CMSSW/CMSSW_7_6_3/src/UHH2/VLQToTopAndLepton/config/"){
  TString directories[] = {"Selection_v31/","EleSelection_v6_tree/"};//,"EleSelection_v4_btag/","BTag_variation_up_Mu/","BTag_variation_down_Mu/","PU_variation_up_Mu/","PU_variation_down_Mu/","SF_muonID_up_Mu/","SF_muonID_down_Mu/"
